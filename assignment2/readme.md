...
Q5. What is the result of this expression: “*” * 10 
...
Q7. How is CPython different from Jython? 
...
Q8. How is CPython different from IronPython? 
...
Q3. When should we use “”” (tripe quotes) to define strings? 
...
Q4. Assuming (name = “John Smith”), what does name[1] return? 

 A: Return character at index 1 which is ‘o’ 

Q5. What about the name[-2]? 

 A: Returns second last character. 

Q6. What about the name[1:-1]? 

 A: Return substring from index 1 to second last character.

Q7. How to get the length of a name? 

 A: By using len function len(name) 

Q8. What are the escape sequences in Python? 
...
Q9. What is the result of f“{2+2}+{10%3}”? 

 A: 4+1 

Q10. Given (name = “john smith”), what will name.title() return? 
...
Q2. All functions in Python by default return …?
...
Q4. How can we make a parameter of a function optional? 
...
Q5. What happens when we prefix a parameter with an asterisk (*)? 
...
Q8. What is the difference between local and global variables? 
...
Q9. Why is using the global statement a bad practice? 
...
Q4. Write a function called showNumbers that takes a parameter called limit. It should print all  the numbers between 0 and limit with a label to identify the even and odd numbers. For  example, if the limit is 3, it should print: 
  o 0 EVEN 
  o 1 ODD 
  o 2 EVEN 
  o 3 ODD 

Q5. Write a function that returns the sum of multiples of 3 and 5 between 0 and limit (parameter).  For example, if the limit is 20, it should return the sum of 3, 5, 6, 9, 10, 12, 15, 18, 20. 

Q6. Write a function called show_stars(rows). If rows is 5, it should print the following: o * 
  o ** 
  o *** 
  o **** 
  o ***** 

Q7. Write a function that prints all the prime numbers between 0 and limit where limit is a  parameter.
